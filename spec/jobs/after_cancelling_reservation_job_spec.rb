...
RSpec.describe AfterCancellingReservationJob do
  describe "#perform" do
    ...
    before do
      ...
      allow(broadcaster_double).to receive(:broadcast_cancelled).and_return(nil)
    end

    it "calls the TicketReservationBroadcaster.broadcast_cancelled with the event_id and reservation_reference" do
      ...
      expect(broadcaster_double).to have_received(:broadcast_cancelled)
    end
  end
end
